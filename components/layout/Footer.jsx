        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/eras" className="text-white/60 hover:text-[#e94560] transition-colors text-sm">
                  All Eras
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-white/60 hover:text-[#e94560] transition-colors text-sm">
                  About
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/era/1920s" className="text-white/60 hover:text-[#e94560] transition-colors text-sm">
                  1920s - Roaring Twenties
                </Link>
              </li>
              <li>
                <Link href="/era/1960s" className="text-white/60 hover:text-[#e94560] transition-colors text-sm">
                  1960s - Mod Revolution
                </Link>
              </li>
              <li>
                <Link href="/era/1980s" className="text-white/60 hover:text-[#e94560] transition-colors text-sm">
                  1980s - Power & Excess
                </Link>
              </li>
              <li>
                <Link href="/era/2020s" className="text-white/60 hover:text-[#e94560] transition-colors text-sm">
                  2020s - Digital Age
                </Link>
              </li>
            </ul>
